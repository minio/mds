import t, { Fragment as a } from "react";
import e, {
  ThemeProvider as n,
...
var o = "#fff",
  ...
  y = {
    ...
    buttons: {
      regular: {
        ...
        disabled: { border: d, text: d, background: f, iconColor: d },
      ...
      secondary: {
        enabled: { border: m, text: m, background: o, iconColor: m },
        disabled: { border: d, text: d, background: f, iconColor: d },
        hover: {
          border: "#C83B51",
          text: m,
        ...
        pressed: { border: m, text: o, background: m, iconColor: o },
      },
    },
  },
  w = {
  ...
  L = function (a) {
    var e = a.darkMode,
      r = void 0 !== e && e,
      o = a.children;
    return t.createElement(n, { theme: r ? w : y }, o);
  },
  M = function () {
    return (
      (M =
...
var x =
    "undefined" != typeof globalThis
      ...
      : {},
  C = Array.isArray,
  S = "object" == typeof x && x && x.Object === Object && x,
  N = "object" == typeof self && self && self.Object === Object && self,
  _ = S || N || Function("return this")(),
  k = _.Symbol,
  B = k,
  O = Object.prototype,
  j = O.hasOwnProperty,
...
var G = function (t) {
    return "symbol" == typeof t || (T(t) && "[object Symbol]" == R(t));
  },
  U = C,
  J = G,
  K = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
...
var et,
  ...
  rt = _["__core-js_shared__"],
  ot = (et = /[^.]+$/.exec((rt && rt.keys && rt.keys.IE_PROTO) || ""))
    ? "Symbol(src)_1." + et
    : "";
var lt = function (t) {
    return !!ot && ot in t;
...
var gt = function (t) {
    return !(!ht(t) || it(t)) && (st(t) ? bt : ft).test(mt(t));
  },
  Zt = function (t, a) {
...
var Nt = Et,
  ...
  Bt = function (t) {
    var a = this.__data__;
    return xt ? void 0 !== a[t] : Ct.call(a, t);
  },
  Ot = function (t, a) {
    var e = this.__data__;
    return (
      (this.size += this.has(t) ? 0 : 1),
      (e[t] = St && void 0 === a ? "__lodash_hash_undefined__" : a),
      this
    );
  };
function jt(t) {
...
var Ft = function (t, a) {
    for (var e = t.length; e--; ) if (It(t[e][0], a)) return e;
    return -1;
  },
  Pt = Ft,
...
var Tt = zt,
  Gt = function (t) {
    ...
    return (
      !(e < 0) &&
      (e == a.length - 1 ? a.pop() : Dt.call(a, e, 1), --this.size, !0)
    );
  },
  Ut = function (t) {
    var a = this.__data__,
...
var ra = function (t, a) {
    var e = t.__data__;
    return na(a) ? e["string" == typeof a ? "string" : "hash"] : e.map;
  },
  oa = ra;
var la = ra;
var ca = ra;
...
function pa(t, a) {
  ...
  return (e.cache = new (pa.Cache || va)()), e;
}
pa.Cache = va;
var ba = pa;
var ga =
...
var Aa = function (t, a) {
  ...
  Ha = C,
  Ea = G,
  ya = k ? k.prototype : void 0,
  wa = ya ? ya.toString : void 0;
var La = function t(a) {
    if ("string" == typeof a) return a;
    if (Ha(a)) return Aa(a, t) + "";
    if (Ea(a)) return wa ? wa.call(a) : "";
    var e = a + "";
...
var _a = G;
var ka = function (t, a) {
    return xa(t) ? t : Ca(t, a) ? [t] : Sa(Na(t));
  },
  Ba = function (t) {
...
var Oa = function (t, a) {
  for (var e = 0, n = (a = ka(a, t)).length; null != t && e < n; )
    t = t[Ba(a[e++])];
...
var ja,
  ...
  za,
  Ia = function (t, a, e) {
    var n = null == t ? void 0 : Oa(t, a);
    return void 0 === n ? e : n;
  },
  Fa = require("../assets/fonts/Lato/Lato-Black.woff"),
  Pa = require("../assets/fonts/Lato/Lato-BlackItalic.woff"),
  Da = require("../assets/fonts/Lato/Lato-Bold.woff"),
  Wa = require("../assets/fonts/Lato/Lato-BoldItalic.woff"),
  $a = require("../assets/fonts/Lato/Lato-Hairline.woff"),
  Ra = require("../assets/fonts/Lato/Lato-HairlineItalic.woff"),
  Ta = require("../assets/fonts/Lato/Lato-Italic.woff"),
  Ga = require("../assets/fonts/Lato/Lato-Light.woff"),
  Ua = require("../assets/fonts/Lato/Lato-LightItalic.woff"),
  Ja = require("../assets/fonts/Lato/Lato-Regular.woff"),
  Ka = require("../assets/fonts/Lato/Lato-Thin.woff"),
  Qa = require("../assets/fonts/Lato/Lato-Black.woff2"),
  Xa = require("../assets/fonts/Lato/Lato-BlackItalic.woff2"),
  Ya = require("../assets/fonts/Lato/Lato-Bold.woff2"),
  te = require("../assets/fonts/Lato/Lato-BoldItalic.woff2"),
  ae = require("../assets/fonts/Lato/Lato-Hairline.woff2"),
  ee = require("../assets/fonts/Lato/Lato-HairlineItalic.woff2"),
  ne = require("../assets/fonts/Lato/Lato-Italic.woff2"),
  re = require("../assets/fonts/Lato/Lato-Light.woff2"),
  oe = require("../assets/fonts/Lato/Lato-LightItalic.woff2"),
  le = require("../assets/fonts/Lato/Lato-Regular.woff2"),
  ce = require("../assets/fonts/Lato/Lato-Thin.woff2"),
  se = r(
    za ||
      ((ja = ["\n    ", "\n"]),
      (qa = ["\n    ", "\n"]),
      Object.defineProperty
        ? Object.defineProperty(ja, "raw", { value: qa })
        : (ja.raw = qa),
      (za = ja)),
    function (t) {
      var a = t.theme;
      return '\n    /* Fonts */\n    @font-face {\n      font-family: "Lato";\n      src: url('
        ...
        .concat(ce, ') format("woff2"),\n        url(')
        .concat(
          Ka,
          ') format("woff");\n      font-weight: 100;\n      font-style: normal;\n      font-display: swap;\n    }\n    \n    /* Main Page styling */\n    \n    *, *::before, *::after {\n       box-sizing: inherit;\n       outline:0;\n    }\n    \n    html {\n        box-sizing: border-box;\n        -webkit-text-size-adjust: 100%;\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n    }\n    \n    body {\n        background-color: '
        )
        .concat(Ia(a, "bgColor", "#fff"), ";\n        color: ")
        .concat(
          Ia(a, "fontColor", "#000"),
          ";\n        height: 100vh;\n        width: 100vw;\n        font-family: 'Lato', sans-serif;\n        margin: 0;\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        font-weight: 400;\n        font-size: 14px;\n        line-height: 1.5;\n        transition: background-color 0s\n    }\n    \n    fieldset, section {\n        border: 1px solid "
        )
        .concat(
          Ia(a, "borderColor", "#E2E2E2"),
      ...
      M(
        {
          ...
          borderColor: Ia(a, "buttons.".concat(i, ".enabled.border"), "#000"),
          borderWidth: "1px",
          borderStyle: "solid",
          color: Ia(a, "buttons.".concat(i, ".enabled.text"), "#000"),
          "& .button-label": M({ whiteSpace: e ? "normal" : "nowrap" }, h),
          "& .buttonIcon": {
            display: "block",
            height: "14px",
            "& > svg": {
              fill: Ia(a, "buttons.".concat(i, ".enabled.text"), "#000"),
              color: Ia(a, "buttons.".concat(i, ".enabled.text"), "#000"),
              width: "14px",
              height: "14px",
            },
          ...
          "&:disabled": {
            ...
            borderWeight: "1px",
            borderStyle: "solid",
            color: Ia(a, "buttons.".concat(i, ".disabled.text"), "#000"),
            "& .buttonIcon > svg": {
              fill: Ia(a, "buttons.".concat(i, ".disabled.text"), "#000"),
              color: Ia(a, "buttons.".concat(i, ".disabled.text"), "#000"),
            },
          },
          "&:hover:not(:disabled)": {
            ...
            borderColor: Ia(a, "buttons.".concat(i, ".hover.border"), "#000"),
            borderWeight: "1px",
            borderStyle: "solid",
            color: Ia(a, "buttons.".concat(i, ".hover.text"), "#000"),
            "& .buttonIcon > svg": {
              fill: Ia(a, "buttons.".concat(i, ".hover.text"), "#000"),
              color: Ia(a, "buttons.".concat(i, ".hover.text"), "#000"),
            },
          },
          "&:active:not(:disabled)": {
            ...
            border: Ia(a, "buttons.".concat(i, ".pressed.border"), "#000"),
            borderWeight: "1px",
            borderStyle: "solid",
            color: Ia(a, "buttons.".concat(i, ".pressed.text"), "#000"),
            "& .buttonIcon > svg": {
              fill: Ia(a, "buttons.".concat(i, ".pressed.text"), "#000"),
              color: Ia(a, "buttons.".concat(i, ".pressed.text"), "#000"),
            },
          },
        },
  ...
  he = function (e) {
    var n = e.label,
      ...
      p = null;
    return (
      l && (p = t.createElement("span", { className: "buttonIcon" }, l)),
      t.createElement(
        ie,
        M(
          {
  ...
  me = e.svg(function (t) {
    var a = Ia(t, "theme.logoLabelColor", "#000");
    return (
      t.inverse && (a = Ia(t, "theme.logoLabelInverse", "#fff")),
      {
        "& .minioSection": { fill: Ia(t, "theme.logoColor", "#C51C3F") },
  ...
  fe = function (a) {
    ...
    return t.createElement(
      me,
      { viewBox: "0 0 184.538 50.008", inverse: e },
      t.createElement(
        "g",
  ...
  de = function (a) {
    ...
    return t.createElement(
      me,
      { viewBox: "0 0 184.45 54.229", inverse: e },
      t.createElement(
        "g",
        { transform: "translate(-31.65 -18.133)" },
        t.createElement(
  ...
  ue = function (a) {
    ...
    return t.createElement(
      me,
      { viewBox: "0 0 184.45 50.008", inverse: e },
      t.createElement(
        "g",
        { transform: "translate(-31.65 -18.133)" },
        t.createElement(
  ...
  Ve = function (a) {
    ...
    switch (e) {
      case "console":
        switch (r) {
          case "standard":
            return t.createElement(fe, { inverse: !!o });
          case "enterprise":
            return t.createElement(ue, { inverse: !!o });
          case "AGPL":
            return t.createElement(de, { inverse: !!o });
          default:
            return t.createElement(Ze, { inverse: !!o });
        }
      case "directpv":
        return t.createElement(pe, { inverse: !!o });
      case "subnet":
        return t.createElement(ge, { inverse: !!o });
      case "kes":
        return t.createElement(be, { inverse: !!o });
      case "operator":
        return t.createElement(ve, { inverse: !!o });
    }
  },
  Ae = e.svg(function (t) {
    return { fill: Ia(t, "theme.logoColor", "#C51C3F") };
  }),
  He = function (a) {
    var e = a.width;
    return t.createElement(
      Ae,
      { viewBox: "0 0 162.612 24.465", width: e },
      t.createElement("path", {
