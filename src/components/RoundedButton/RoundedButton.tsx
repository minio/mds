...
>(
  ({
    ...
    return {
      ...
      background: get(
        theme,
        `roundedButtons.${neatVariant}.enabled.background`,
        "#fff",
      ),
      borderColor: get(
        theme,
        `roundedButtons.${neatVariant}.enabled.border`,
        "#000",
      ),
      borderWidth: 1,
      borderStyle: "solid",
      color: get(theme, `roundedButtons.${neatVariant}.enabled.text`, "#000"),
      boxShadow: get(
        theme,
        `roundedButtons.${neatVariant}.enabled.shadow`,
        "none",
      ),
      "& .button-label": {
      ...
      "&:disabled": {
        ...
        background: get(
          theme,
          `roundedButtons.${neatVariant}.disabled.background`,
          "#fff",
        ),
        borderColor: get(
          theme,
          `roundedButtons.${neatVariant}.disabled.border`,
          "#000",
        ),
        borderWeight: 1,
        borderStyle: "solid",
        ...
        boxShadow: get(
          theme,
          `roundedButtons.${neatVariant}.disabled.shadow`,
          "none",
        ),
        "& .buttonIcon > svg": {
          color: get(
      ...
      "&:hover:not(:disabled)": {
        background: get(
          theme,
          `roundedButtons.${neatVariant}.hover.background`,
          "#fff",
        ),
        borderColor: get(
          theme,
          `roundedButtons.${neatVariant}.hover.border`,
          "#000",
        ),
        color: get(theme, `roundedButtons.${neatVariant}.hover.text`, "#000"),
        boxShadow: get(
          theme,
          `roundedButtons.${neatVariant}.hover.shadow`,
          "none",
        ),
        "& .buttonIcon > svg": {
          color: get(theme, `roundedButtons.${neatVariant}.hover.text`, "#000"),
      ...
      "&:active:not(:disabled)": {
        background: get(
          theme,
          `roundedButtons.${neatVariant}.pressed.background`,
          "#fff",
        ),
        borderColor: get(
          theme,
          `roundedButtons.${neatVariant}.pressed.border`,
          "#000",
        ),
        color: get(theme, `roundedButtons.${neatVariant}.pressed.text`, "#000"),
        boxShadow: get(
          theme,
          `roundedButtons.${neatVariant}.pressed.shadow`,
          "none",
        ),
        "& .buttonIcon > svg": {
          color: get(
